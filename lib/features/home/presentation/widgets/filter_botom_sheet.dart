          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  AppText(
                    text: AppLocalizations.of(context)!.translate('filtering')!,
                  ...
                  children: [
                    CheckBoxWidget(
                      ...
                      onOptionChanged: (index, value) {
                        context
                            .read<FiltersCubit>()
                            .updateCategoryOption(index, value);
                      },
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    CheckBoxWidget(
                      ...
                      onOptionChanged: (index, value) {
                        context
                            .read<FiltersCubit>()
                            .updateExperiencesOption(index, value);
                      },
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    CheckBoxWidget(
                      ...
                      onOptionChanged: (index, value) {
                        context
                            .read<FiltersCubit>()
                            .updateDestinationsOption(index, value);
                      },
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    CheckBoxRatingWidget(
                      ...
                      onOptionChanged: (index, value) {
                        context
                            .read<FiltersCubit>()
                            .updateRatingOption(index, value);
                      },
                    ),
                  ],
                );
